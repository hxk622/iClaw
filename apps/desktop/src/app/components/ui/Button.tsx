...
const VARIANT_CLASSES: Record<ButtonVariant, string> = {
  primary:
    'border border-transparent bg-[var(--brand-primary)] text-[var(--brand-on-primary)] shadow-[0_12px_28px_rgba(59,130,246,0.22)] hover:bg-[var(--brand-primary-hover)] hover:text-[var(--brand-on-primary)] hover:shadow-[0_16px_34px_rgba(59,130,246,0.28)] dark:border-[rgba(201,169,97,0.22)] dark:bg-[var(--brand-primary)] dark:text-[#17110a] dark:shadow-[0_14px_28px_rgba(0,0,0,0.28)] dark:hover:border-[rgba(201,169,97,0.30)] dark:hover:bg-[var(--brand-primary-hover)] dark:hover:text-[#120d08] dark:hover:shadow-[0_18px_36px_rgba(0,0,0,0.34)]',
  secondary:
