...
export const APPLE_FLAT_SURFACE =
  'shadow-[0_1px_2px_rgba(18,15,11,0.05),inset_0_1px_0_rgba(255,255,255,0.56)] backdrop-blur-sm dark:shadow-[0_1px_2px_rgba(0,0,0,0.22),inset_0_1px_0_rgba(255,255,255,0.05)]';
