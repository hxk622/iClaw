...
function toMarketStockView(record: MarketStockRecord): MarketStockView {
  return {
    ...
    quote_source: record.quoteSource,
    quote_snapshot_at: record.quoteSnapshotAt,
    quote_trade_date: record.quoteTradeDate,
    quote_is_delayed: record.quoteIsDelayed,
    fundamentals_source: record.fundamentalsSource,
    fundamentals_updated_at: record.fundamentalsUpdatedAt,
    industry: record.industry,
    region: record.region,
    main_business: record.mainBusiness,
    list_date: record.listDate,
...
function toMarketFundView(record: MarketFundRecord): MarketFundView {
  return {
    ...
    quote_snapshot_at: record.quoteSnapshotAt,
    quote_is_delayed: record.quoteIsDelayed,
    latest_nav_date: record.latestNavDate,
    manager_work_time: record.managerWorkTime,
    manager_fund_size_text: record.managerFundSizeText,
    watchlisted: record.watchlisted,
    theme_key: record.themeKey,
    summary: record.summary,
    ai_focus: record.aiFocus,
    asset_allocation: record.assetAllocation,
    strategy_tags: record.strategyTags,
    metadata: record.metadata,
    imported_at: record.importedAt,
    updated_at: record.updatedAt,
