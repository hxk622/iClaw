...
function defaultMarketingSiteConfigFromApp(appName: string, config: PortalJsonObject): PortalJsonObject {
  ...
  const isWealth = appName === 'caiclaw';
        ...
        blocks: [
          {
            ...
            enabled: true,
            sortOrder: 10,
            props: {title: legalPages.privacyTitle, content: legalPages.privacyContent},
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            enabled: true,
            sortOrder: 10,
            props: {title: legalPages.termsTitle, content: legalPages.termsContent},
          },
        ],
      },
    ],
  ...
  async applyBaselineSnapshot(input: {
    ...
    try {
      ...
      for (const app of input.apps) {
        ...
        await replaceMarketingSiteBindings(client, app.appName, asJsonObject(app.config));
      }
